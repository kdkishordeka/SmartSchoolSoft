...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col col-md-6">
                                        <i class="fas fa-table me-1"></i> Account Management
                                    </div>
                                    <div class="col col-md-6" align="right">
                                        <a href="?url=admin/registerAccount" class="btn btn-success btn-sm">Add Account</a>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            const loadAccount = ()=>{
                $.post("?q=account/fetchData", {load:"load"}, (html)=>$("#loadData").html(html));
            }
        </script>
    </body>
</html>