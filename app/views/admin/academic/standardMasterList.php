...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col col-md-6" align="right">
                                        <a href="?url=admin/academicStandardRegister" class="btn btn-success btn-sm">Add Class</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
        ...
        <script>
            ...
            const loadRecord =()=>{$.post("?q=schoolClass/loadData/all", (html)=>$("#loadStandard").html(html))}
        </script>
    </body>
</html>