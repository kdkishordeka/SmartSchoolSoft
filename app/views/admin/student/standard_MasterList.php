...
<html lang="en">
    <head>
        ...
        <title>Smart School Soft - School Management Software - Student Standard Management</title>
...
<!--                                        <a href="?url=admin/studentStandarRegister" class="btn btn-success btn-sm">Add</a>-->
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
        ...
        <script>
            ...
            const fatchData = ()=>{
                $.get("?q=admission/fetchStudentStandard/all",(html)=>$("#loadStudent").html(html));
            }
        </script>
    </body>
</html>